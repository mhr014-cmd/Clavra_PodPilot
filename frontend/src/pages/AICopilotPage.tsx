...
const QUICK_CHIPS = [
  ...
  { text: "What can you help me with?",         icon: "💡", color: "teal"   },
];
...
const WELCOME_MSG: Message = {
  ...
  role: "assistant",
  content:
    "Hello! 👋 I'm your **ProdPilot AI Copilot** — your factory assistant.\n\n" +
    "I can help you with:\n" +
    "- 📋 **Orders** — track, check status, cancel\n" +
    "- 🚢 **Shipments** — check what's going out or in transit\n" +
    "- 📦 **Inventory** — stock levels and low-stock alerts\n" +
    "- 📊 **Analytics** — production efficiency, trends\n" +
    "- 📄 **Documents** — search your uploaded policies and manuals\n\n" +
    "Just ask naturally — or tap **'Give me a factory summary'** to see everything at once.",
